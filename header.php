...
<head>
    ...
    <link rel="icon" href="./images/logo34.png" type="image/gif" sizes="16x16">
    <script>
        ...
        <div class="header_t">
            <div class="row">
                <div class="col-md-3 mt-2">
                    ...
                    <span style="color:#f15b2c;font-size:14px; padding-left:5px">
                        ০৯৬৩৮০০০৭৭৭
                    </span>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item ">
                                    <a class="nav-link" href="#">আজকেরডিলে সেল করুন <span class="sr-only"></span></a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">&nbsp;&nbsp;<font style='color:#febe10'>
                                            <img src="./images/topordertrack.png" alt="">
        ...
        <div class="header_m">
            <div class="row">
                <div class="col-md-2" id="logo">
                    <a href="index.php">
                        <img src="./images/logo34.png" alt="" width="190" height="100">
            ...
            <div class="col-md-2" id="list_img">
                <!-- <a href="#">
                ...
                <img src="./images/call-now.gif" alt="call now button">
