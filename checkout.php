                        ...
                        <table class="table table-bordered">
                           ...
                           <tbody>
                              <tr class="rem1">
                                 ...
                                 <td class="invert-image"><a href="single.php"><img src="./images/shart/shart1.jpg" alt=" " class="img-responsive"></a></td>
                                 <td class="invert">
                                    <div class="quantity">
                              ...
                              <tr class="rem2">
                                 ...
                                 <td class="invert-image"><a href="single.php"><img src="images/watch/watch1.jpg" alt=" " class="img-responsive"></a></td>
                                 <td class="invert">
                                    <div class="quantity">
                                       <div class="quantity-select">
                                          <div class="entry value-minus">&nbsp;</div>
                              ...
                              <tr class="rem3">
                                 ...
                                 <td class="invert-image"><a href="single.php"><img src="images/worldcup/world2.jpg" alt=" " class="img-responsive"></a></td>
                                 <td class="invert">
                                    <div class="quantity">
                                       <div class="quantity-select">
                                          <div class="entry value-minus">&nbsp;</div>
